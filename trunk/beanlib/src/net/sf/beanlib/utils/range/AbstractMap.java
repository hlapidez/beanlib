...
/**
 * Cloned from and identical to {@link java.util.AbstractMap}, except it is now
...
public abstract class AbstractMap<K, V> implements Map<K, V> 
{
     ...
     * the specified value. If such an entry is found, <tt>true</tt> is
     ...
     *             if the key is <tt>null</tt> and this map does not permit
     *             <tt>null</tt> keys.
     */
     ...
     * 
     * @throws NullPointerException
     *             if this map does not permit <tt>null</tt> keys or values,
     ...
     * returned. Note that this implementation requires linear time in the size
     ...
     * @return previous value associated with specified key, or <tt>null</tt>
     *         if there was no entry for key. (A <tt>null</tt> return can also
     ...
     * 
     * @throws UnsupportedOperationException
     *             if the <tt>putAll</tt> operation is not supported by this
     *             map.
     * 
     * @throws ClassCastException
     ...
     * @throws NullPointerException
     *             if the specified map is <tt>null</tt>, or if this map does
     *             not permit <tt>null</tt> keys or values, and the specified
     ...
     * 
     * Note that this implementation throws an
     * <tt>UnsupportedOperationException</tt> if the <tt>entrySet</tt> does
     * not support the <tt>clear</tt> operation.
     * 
     * @throws UnsupportedOperationException
    ...
    /**
     * This should be made public as soon as possible. It greatly simplifies the
     * task of implementing Map.
     */
