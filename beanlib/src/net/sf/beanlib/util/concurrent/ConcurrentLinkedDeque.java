...
import net.sf.beanlib.util.AbstractCollection;
...
public class ConcurrentLinkedDeque<E>
    ...
    private static final long serialVersionUID = 6405162887005322876L;
    ...
    Node(Node<E> next) { 
         ...
         */
        @SuppressWarnings("unchecked") boolean delete() {
            Node<E> b = getPrev();
            Node<E> f = getNext();
         ...
         * @return the new node, or null on failure.
         */
        @SuppressWarnings("unchecked") Node<E> replace(E newElement) {
            for (;;) {
                Node<E> b = getPrev();
                Node<E> f = getNext();
                if (b == null || f == null || f.isMarker())
    ...
    /** 
     * hchar: This method was missing in the original jsr166x bundle,
     * so I added one that mirrors the <code>iterator()</code> method. 
     */ 
